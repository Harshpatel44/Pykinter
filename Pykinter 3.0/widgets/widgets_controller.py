...
class WidgetsTab:
    ...
    def tab_gui(self):
        ...
        #
        tool_button = tk.Button(widget_frame, text="Tool Button", height=1, width=10, bd=0,
        ...
        #
        radio_button = tk.Button(widget_frame, text="Radio Button", height=1, bd=0, width=15, background="#6D7993",
        ...
        #
        check_button = tk.Button(widget_frame, text="Check Button", height=1, bd=0, width=15, background="#6D7993",
        ...
        #
        entrybox=tk.Button(widget_frame,text="Entry Box",height=1,bd=0,width=15,background="#6D7993",
        ...
        #
        label=tk.Button(widget_frame, text="Label", height=1, bd=0,width=15, background="#6D7993",
        ...
        #
        scroll_bar=tk.Button(widget_frame,text="Scroll Bar",height=1,bd=0,width=15,background="#6D7993",
        ...
        #
        progress_bar=tk.Button(widget_frame,text="Progress Bar",height=1,bd=0,width=15,background="#6D7993",
        ...
        #
        spin_box=tk.Button(widget_frame,text="Spin Box",height=1,bd=0,width=15,background="#6D7993",
        ...
        #
        combo_box=tk.Button(widget_frame,text="Combo Box",height=1,bd=0,width=15,background="#6D7993",
        ...
        #
        drop_view=tk.Button(widget_frame,text="Drop View",height=1,bd=0,width=15,background="#6D7993",
        ...
        #
        list_view=tk.Button(widget_frame,text="List View",height=1,bd=0,width=15,background="#6D7993",
        ...
        #
        frame=tk.Button(widget_frame,text="Frame",height=1,bd=0,width=15,background="#6D7993",
        ...
        #
        spiner=tk.Button(widget_frame,text="Spiner",height=1,bd=0,width=15,background="#6D7993",
                         fg="#FFFFFF",relief="solid")
        ...
        #
        shapes=tk.Button(widget_frame,text="Shapes",height=1,bd=0,width=15,background="#6D7993",
                         fg="#FFFFFF",relief="solid")
        ...
        #
        image_insert=tk.Button(widget_frame,text="Image",height=1,bd=0,width=15,background="#6D7993",
