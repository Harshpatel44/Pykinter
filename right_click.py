...
def menu_start(event,root,rc,start_btn,motion,stop_btn,l1,l2,right1,right2,u,d,l,r):
    ...
    if(org_widget.winfo_class()=="Entry"):
        ...
        r6=rc.create_rectangle(30,80,155,110,fill="#f7f7f7",activefill="#d9d9d9",outline="#f7f7f7",activeoutline="#d9d9d9")
        ...
        r7=rc.create_rectangle(30,100,155,120,fill="#f7f7f7",activefill="#d9d9d9",outline="#f7f7f7",activeoutline="#d9d9d9")
        ...
        r8=rc.create_rectangle(30,120,155,140,fill="#f7f7f7",activefill="#d9d9d9",outline="#f7f7f7",activeoutline="#d9d9d9")
        ...
        r9=rc.create_rectangle(30,140,155,160,fill="#f7f7f7",activefill="#d9d9d9",outline="#f7f7f7",activeoutline="#d9d9d9")
