...
class main_frame(tk.Frame, main):
    ...
    def tb(self, main):
        ...
        title_bar = tk.Frame(self, height=20, width=1300, highlightthickness=1, relief='solid', background="white",
    ...
    def eb(self, main, controller):  # extra bar
        extra_bar = tk.Frame(self, height=25, width=1300, highlightthickness=1, highlightbackground="#555555",
                             relief='solid', background='#6D7993')
        extra_bar.pack()

        editor_button = tk.Button(extra_bar, text="Editor", relief="flat",
                                  command=lambda: controller.show_frame(editor_frame))
        editor_button.place(x=400, y=1)
        design_button = tk.Button(extra_bar, text="Design", relief="flat",
